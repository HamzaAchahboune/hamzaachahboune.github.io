...
# <span style="color:#DEFF58">I'm a Network</span> and Computer Science Engineering Student
...
<div style="display: flex;">
    <div style="border: 1px solid #ccc; flex: 1; margin: 10px; padding: 10px; border-radius: 5px; box-shadow: 2px 2px 4px #888; background-color: #1E1E1E;">
        ...
        <p style="color: #DEFF58;">Moroccan School of Engineering Sciences Tangier (2022 - 2023)</p>
    </div>
</div>
...
<div style="display: flex;">
    <div style="border: 1px solid #ccc; flex: 1; margin: 10px; padding: 10px; border-radius: 5px; box-shadow: 2px 2px 4px #888; background-color: #1E1E1E;">
        ...
        <p style="color: #DEFF58;">Specialized Institute of Applied Technology Khenifra (2019/2021)</p>
    </div>
</div>
...
<div style="display: flex;">
    <div style="border: 1px solid #ccc; flex: 1; margin: 10px; padding: 10px; border-radius: 5px; box-shadow: 2px 2px 4px #888; background-color: #1E1E1E;">
        ...
        <p style="color: #DEFF58;">Moulay Rachid High School (2018/2019)</p>
    </div>
</div>
...
<div style="display: flex;">
    <div style="border: 1px solid #ccc; flex: 1; margin: 10px; padding: 10px; border-radius: 5px; box-shadow: 2px 2px 4px #888; background-color: #1E1E1E;">
        ...
        <p style="color: #DEFF58;">Yafa Technologies - Tetouan (2023/07 - 2023/08)</p>
        <ul style="color: #fff;">
...
<div style="display: flex;">
    <div style="border: 1px solid #ccc; flex: 1; margin: 10px; padding: 10px; border-radius: 5px; box-shadow: 2px 2px 4px #888; background-color: #1E1E1E;">
        ...
        <p style="color: #DEFF58;">Cloud Marketing Hub - Tangier (2022/08)</p>
        <ul style="color: #fff;">
            <li>Building a virtual network based on ESXi Technology from VMware (<a href="https://github.com/HamzaAchahboune/ESXI-hypervisor" style="color: #DEFF58; font-weight: bold;" target="_blank">GitHub Link</a>)</li>
            <li>Capturing, deploying, and managing Windows OS in the network using FOGPROJECT (<a href="https://github.com/HamzaAchahboune/Fog_Project" style="color: #DEFF58; font-weight: bold;" target="_blank">GitHub Link</a>)</li>
        </ul>
    </div>
</div>
...
<div style="display: flex;">
    <div style="border: 1px solid #ccc; flex: 1; margin: 10px; padding: 10px; border-radius: 5px; box-shadow: 2px 2px 4px #888; background-color: #1E1E1E;">
        ...
        <p style="color: #DEFF58;">Urban Agency of Khenifra (2021)</p>
        <ul style="color: #fff;">
